var drawMercator = function() {
  ...
  var svg = d3.select("#mercator").append("svg")
      .attr("width", width)
      .attr("height", height);
...
var drawAlbers = function() {
  var width = 960,
      height = 580;

  var projection = d3.geo.albers().scale(180);
  ...
  var svg = d3.select("#albers").append("svg")
      .attr("width", width)
      .attr("height", height);
...
var drawLambert = function() {
  var width = 960,
      height = 580;

  var projection = d3.geo.cylindricalEqualArea().scale(150);
  ...
  var svg = d3.select("#lambert").append("svg")
      .attr("width", width)
      .attr("height", height);
...
var drawProgressions = function() {
  ...
  var svg = d3.select("#projections").append("svg")
      .attr("width", width)
      .attr("height", height);
  ...
  function update(option) {
    ...
    $("#projection-label").text(option.name);
  }
